...
**
** Objective:
** To multiply two 2000 x 2000 matrices whose elements are randomly generated, to run the multiplication 50 times and find the average of each element of the output, to print out the resultant matrix, and to time the program - all using CUDA C.
**
***************************************************************************************************************************************************************************************************************************************************/
