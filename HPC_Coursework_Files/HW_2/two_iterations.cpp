...
int main()
{
    ...
    double time_for_program = 0, avg_time_for_mul = 0, time_for_mul = 0, fin_avg;
    ...
    cout << "Average time of multiplication = " << std::setprecision(9) << fin_avg << endl;
